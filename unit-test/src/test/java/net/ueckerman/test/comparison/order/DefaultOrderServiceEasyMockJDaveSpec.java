...
import static net.ueckerman.test.comparison.product.ProductMother.createProducts;
import static net.ueckerman.test.comparison.user.UserMother.createUser;
